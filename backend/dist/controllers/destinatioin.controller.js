...
export const getLocationName = asyncHandler(async (req, res) => {
...
`, longitude, latitude);
    ...
    return res.status(200)
        .json(new ApiResponse(200, results, "Data retrieve successfully"));
});
...
export const insertNewLoacatioins = asyncHandler(async (req, res) => {
...
export const insertManyLoacatioins = asyncHandler(async (req, res) => {
...
export const getAllLocations = asyncHandler(async (req, res) => {
    ...
    FROM "Destination"
  `);
    return res.status(200).json(new ApiResponse(200, results, "All locations retrieved successfully"));
});
